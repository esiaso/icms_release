<?php
	...
	define('SYSTEM_NAME','iCPDKenya_demo');
	define('WEBPHOTOROOT', '/home/icpduser/demo/images/portraits/');
	define('ACTIVITIESROOT', '/home/icpduser/demo/images/activities/');
	//define('WEBPHOTOROOT', 'http://www.icpdkenya.org/images/portraits/');
	//define('WEBPHOTOROOT', 'D:/xampp/htdocs/cpd/images/portraits/'); //local
	define('WEBLINK','http://demo.icpdkenya.org/'); // Website link
